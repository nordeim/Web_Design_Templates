...
Now, use the above guidelines to help me create a node.js app for a website with the UI shown in the uploaded screenshot image. you can use Next.js with TypeScript, Tailwind CSS and other popular libraries as necessary.
